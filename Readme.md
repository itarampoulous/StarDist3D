...
### Training
Training using a training configuration file (see [examples](./examples/configurations/train_Stadist3D_config.yml)):
> trainStardist3D --config path/to/training_configuration.yml

### Inference
Prediction using a prediction configuration file (see [examples](./examples/configurations/predict_Stardist3D_config.yml)):
> predictStardist3D --config path/to/prediction_configuration.yml

### Evaluation
Evaluation using an evaluation configuration file (see [examples](./examples/configurations/evaluate_Stardist3D_config.yml)):
